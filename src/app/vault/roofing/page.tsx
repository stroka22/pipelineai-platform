...
export default function RoofingVaultPage() {
    ...
    <div className="min-h-screen bg-[#081F33]">
      ...
      <section className="py-16 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Roofing Content <span className="text-[#C96A2B]">Vault</span>
          </h1>
          <p className="text-xl text-white/60 max-w-2xl mx-auto">
            Preview our ready-to-customize roofing content. Each piece gets branded with your logo, 
        ...
        <div className="max-w-7xl mx-auto px-6">
          {filteredItems.length === 0 ? (
            <div className="text-center py-20">
              ...
              <p className="text-white/40">Roofing content is being added to the vault.</p>
            </div>
          ) : (
      ...
      <section className="py-16 border-t border-white/10">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-white/60 mb-8">Get professionally designed roofing content customized with your branding.</p>
