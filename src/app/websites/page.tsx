        ...
        <div className="max-w-6xl mx-auto px-6 flex justify-between items-center">
          <a href="/" className="flex items-center gap-2">
            <svg className="w-8 h-8" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M12 14h6v12h-3V17h-3v-3zm10 0h6c1.5 0 3 1 3 3v2c0 2-1.5 3-3 3h-3v4h-3V14zm3 5h2c.5 0 1-.3 1-1v-1c0-.7-.5-1-1-1h-2v3z" fill="white"/>
              <defs>
            ...
            <span className="text-xl font-bold text-gray-900">Pipeline<span className="text-emerald-500">AI</span></span>
          </a>
